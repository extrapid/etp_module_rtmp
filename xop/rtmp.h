...
static const int RTMP_SET_CHUNK_SIZE = 0x1; /* ���ÿ��С */
static const int RTMP_AOBRT_MESSAGE = 0X2;	/* ��ֹ��Ϣ */
static const int RTMP_ACK = 0x3;			/* ȷ�� */
static const int RTMP_USER_EVENT = 0x4;		/* �û�������Ϣ */
static const int RTMP_ACK_SIZE = 0x5;		/* ���ڴ�Сȷ�� */
static const int RTMP_BANDWIDTH_SIZE = 0x6; /* ���öԶ˴��� */
